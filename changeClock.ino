...
char ssid[] = "KT_GiGA_5227";
char pass[] = "8cjg15ej00";

#define TZ (9*60*60) /*KST*/
...
void setup(){
  ...
  configTime(TZ, 0, "time.bora.net", "time.windows.com"); // enable NTP
   matrix.begin();
}
...
{             
  ...
  struct tm *tm;
  static const char* const wd[7] = {"Sun", "Mon", "Tue", "Wed","Tue", "Fri", "Sat"};
